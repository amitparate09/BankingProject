...
import com.bankingproject.utilities.ExcelUtils;
...

{
	...
	{
		String path = "/Users/amitparate/Desktop/Amit workspace/BankingProject/src/test/java/com/bankingproject/testdata/LoginData.xlsx";
		...
		for (int i = 1; i <= rownum; i++) 
		{
			...
			{
				logindata[i][j] = ExcelUtils.getCellData(path,"Sheet1",i, j);
			}
		}
	return logindata;
	}
